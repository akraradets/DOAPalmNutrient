...
full_train_dataset = PalmNutriDataset(ground_truth=ground_truth, img_dir='dataset', sample_set='k17', filter=True)
print(len(full_train_dataset)) # => 900

train_dataset, val_dataset = torch.utils.data.random_split(full_train_dataset, [615,156])
