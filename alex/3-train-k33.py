...
full_train_dataset = PalmNutriDataset(ground_truth=ground_truth, img_dir='dataset', sample_set='k33')
print(len(full_train_dataset)) # => 872

train_dataset, val_dataset = torch.utils.data.random_split(full_train_dataset, [750,122])
